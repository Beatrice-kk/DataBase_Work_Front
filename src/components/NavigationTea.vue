                ...
                <el-menu :default-openeds="['1', '2']" id="navMenu" class="el-menu-vertical-demo" @select="handleSelect"
                    ...
                    <el-sub-menu index="1" class="vertical-submenu">
                        ...
                        <template class="vertical-submenu">
                            <el-menu-item index="1-1">&emsp;录入成绩</el-menu-item>
                        </template>
                    </el-sub-menu>
                    <el-sub-menu index="2" class="vertical-submenu">
                        ...
                        <template class="vertical-submenu">
                            <el-menu-item index="2-1">&emsp;查询课表</el-menu-item>
                            <el-menu-item index="2-2">&emsp;查询授课平均成绩</el-menu-item>
                        </template>
                    </el-sub-menu>
                </el-menu>
            </el-scrollbar>
    ...
    setup() {
        ...
        const handleSelect = (index) => {
            if (index === '0') {
                ...
                router.push('/teacher/teacheraddscore');
            } else if (index === '2-1') {
                router.push('/teacher/teachersearchclass');
            } else if (index === '2-2') {
                router.push('/teacher/teacheravgscore');
            }
        };
