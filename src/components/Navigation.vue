                    ...
                    <el-sub-menu index="1" class="vertical-submenu">
                        ...
                        <template class="vertical-submenu">
                            <el-menu-item index="1-1"
                                >&emsp;管理教师</el-menu-item
                            >
                            <el-menu-item index="1-2"
                                >&emsp;管理学生</el-menu-item
                            >
                            <el-menu-item index="1-3"
                                >&emsp;管理专业</el-menu-item
                            >
                            <el-menu-item index="1-4"
                                >&emsp;管理班级</el-menu-item
                            >
                            <el-menu-item index="1-5"
                                >&emsp;管理课程</el-menu-item
                            >
                            <el-menu-item index="1-6"
                                >&emsp;管理课表</el-menu-item
                            >
                            <el-menu-item
                                index="1-7"
                                :disabled="UserOccupation2"
                                >&emsp;管理学院</el-menu-item
                            >
                        </template>
                    </el-sub-menu>
                    <el-sub-menu index="2" class="vertical-submenu">
                        <template #title>
                            <span>查询</span>
                        </template>
                        <template class="vertical-submenu">
                            <el-menu-item index="2-1"
                                >&emsp;学年成绩查询</el-menu-item
                            >
                            <el-menu-item index="2-2"
                                >&emsp;平均成绩查询</el-menu-item
                            >
                            <el-menu-item index="2-3"
                                >&emsp;成绩排名查询</el-menu-item
                            >
                            <el-menu-item index="2-4"
                                >&emsp;地区人数统计</el-menu-item
                            >
                        </template>
                    </el-sub-menu>
                </el-menu>
    ...
    setup() {
        ...
        const handleSelect = (index) => {
            if (index === "0") {
                ...
                router.push("/admin/major-management");
            } else if (index === "1-4") {
                router.push("/admin/class-management");
            } else if (index === "1-5") {
                router.push("/admin/course-management");
            } else if (index === "1-6") {
                router.push("/admin/courseset-management");
            } else if (index === "1-7") {
                router.push("/admin/department-management");
            } else if (index === "2-1") {
                router.push("/admin/scoresearch");
            } else if (index === "2-2") {
                router.push("/admin/avgscoresearch");
            } else if (index === "2-3") {
                router.push("/admin/scorerank");
            } else if (index === "2-4") {
                router.push("/admin/hometowm");
            }
        };
        ...
        if (
            sessionStorage.getItem("occupation") === "manger_g" ||
            sessionStorage.getItem("occupation") === "cto"
        ) {
