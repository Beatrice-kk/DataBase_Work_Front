/*
 ...
 Source Host           : 192.168.80.133:26000
 ...
 Date: 26/06/2025 00:02:47
*/


-- ----------------------------
-- Table structure for chenwk_admin03
-- ----------------------------
...
CREATE TABLE "public"."chenwk_admin03" (
  ...
  "cwk_role03" varchar(255) COLLATE "pg_catalog"."default"
)
;
...
-- ----------------------------
INSERT INTO "public"."chenwk_admin03" VALUES (66666, '123456', 'SUPER_ADMIN');
INSERT INTO "public"."chenwk_admin03" VALUES (88888, '1234567', 'SUPER_ADMIN');
INSERT INTO "public"."chenwk_admin03" VALUES (999999, '12345678', 'SUPER_ADMIN');

-- ----------------------------
-- Table structure for chenwk_class03
-- ----------------------------
...
-- ----------------------------
-- Table structure for chenwk_college03
-- ----------------------------
...
-- ----------------------------
-- Table structure for chenwk_course03
-- ----------------------------
...
-- 
-- -- ----------------------------
-- -- Records of chenwk_course03
-- -- ----------------------------
-- -- 计算机科学与技术学院(10000)的课程
-- INSERT INTO "public"."chenwk_course03" VALUES ('1002   ', '计算机网络原理', '2024-2025(1)', 10000, '考试', 3, 48, '必修课', 2024);
-- INSERT INTO "public"."chenwk_course03" VALUES ('1003   ', '计算方法与设计', '2024-2025(2)', 10000, '考察', 3, 48, '选修课', 2024);
-- INSERT INTO "public"."chenwk_course03" VALUES ('1001   ', '计算机组成原理', '2024-2025(2)', 10000, '考试', 3, 48, '必修课', 2024);
-- INSERT INTO "public"."chenwk_course03" VALUES ('1000   ', '数据库原理', '2024-2025(2)', 10000, '考试', 3, 48, '必修课', 2024);
-- INSERT INTO "public"."chenwk_course03" VALUES ('1005   ', '算法设计与分析', '2024-2025(2)', 10000, '考试', 3, 48, '选修课', 2025);
-- INSERT INTO "public"."chenwk_course03" VALUES ('1015   ', '数字逻辑电路', '2024-2025(2)', 10000, '考试', 4, 64, '必修课', 2025);
-- INSERT INTO "public"."chenwk_course03" VALUES ('1004   ', '操作系统原理', '2024-2025(1)', 10000, '考试', 4, 64, '必修课', 2024);
-- INSERT INTO "public"."chenwk_course03" VALUES ('1006   ', '软件工程', '2024-2025(1)', 10000, '考察', 3, 48, '必修课', 2024);
-- INSERT INTO "public"."chenwk_course03" VALUES ('1007   ', '人工智能基础', '2024-2025(2)', 10000, '考察', 2, 32, '选修课', 2024);
-- INSERT INTO "public"."chenwk_course03" VALUES ('1008   ', '编译原理', '2024-2025(1)', 10000, '考试', 4, 64, '必修课', 2025);
-- INSERT INTO "public"."chenwk_course03" VALUES ('1009   ', '计算机图形学', '2024-2025(2)', 10000, '考察', 3, 48, '选修课', 2025);
-- INSERT INTO "public"."chenwk_course03" VALUES ('1010   ', '网络安全基础', '2024-2025(1)', 10000, '考试', 3, 48, '选修课', 2025);
-- INSERT INTO "public"."chenwk_course03" VALUES ('1011   ', '大数据技术', '2024-2025(2)', 10000, '考察', 3, 48, '选修课', 2025);
-- INSERT INTO "public"."chenwk_course03" VALUES ('1012   ', '嵌入式系统', '2024-2025(1)', 10000, '考试', 3, 48, '选修课', 2025);
-- INSERT INTO "public"."chenwk_course03" VALUES ('1013   ', '分布式系统', '2024-2025(2)', 10000, '考试', 3, 48, '选修课', 2025);
-- INSERT INTO "public"."chenwk_course03" VALUES ('1014   ', '机器学习', '2024-2025(1)', 10000, '考察', 3, 48, '选修课', 2025);
-- 
-- -- 信息学院(10005)的课程
-- INSERT INTO "public"."chenwk_course03" VALUES ('2000   ', '信号与系统', '2024-2025(1)', 10005, '考试', 4, 64, '必修课', 2024);
-- INSERT INTO "public"."chenwk_course03" VALUES ('2001   ', '通信原理', '2024-2025(2)', 10005, '考试', 3, 48, '必修课', 2024);
-- INSERT INTO "public"."chenwk_course03" VALUES ('2002   ', '数字信号处理', '2024-2025(1)', 10005, '考试', 3, 48, '必修课', 2025);
-- INSERT INTO "public"."chenwk_course03" VALUES ('2003   ', '电磁场与电磁波', '2024-2025(2)', 10005, '考试', 4, 64, '必修课', 2025);
-- 
-- -- 机械学院(10007)的课程
-- INSERT INTO "public"."chenwk_course03" VALUES ('3000   ', '机械设计基础', '2024-2025(1)', 10007, '考试', 4, 64, '必修课', 2024);
-- INSERT INTO "public"."chenwk_course03" VALUES ('3001   ', '材料力学', '2024-2025(2)', 10007, '考试', 3, 48, '必修课', 2024);
-- INSERT INTO "public"."chenwk_course03" VALUES ('3002   ', '机器人学基础', '2024-2025(1)', 10007, '考察', 3, 48, '选修课', 2025);
-- 
-- -- 外国语学院(10010)的课程
-- INSERT INTO "public"."chenwk_course03" VALUES ('4000   ', '高级英语', '2024-2025(1)', 10010, '考察', 2, 32, '必修课', 2024);
-- INSERT INTO "public"."chenwk_course03" VALUES ('4001   ', '翻译理论与实践', '2024-2025(2)', 10010, '考察', 3, 48, '选修课', 2024);
-- INSERT INTO "public"."chenwk_course03" VALUES ('4002   ', '德语入门', '2024-2025(1)', 10010, '考察', 2, 32, '选修课', 2025);
-- 
-- 
-- -- 首先添加期末考试时间列
-- ALTER TABLE "public"."chenwk_course03" ADD COLUMN "cwk_final_exam_date03" DATE;
-- 
-- -- 更新考试课程的期末考试时间(6月20日-6月30日之间随机分配)
-- UPDATE "public"."chenwk_course03" 
-- SET "cwk_final_exam_date03" = 
--   CASE 
--     WHEN "cwk_examination_method03" = '考试' THEN 
--       DATE '2025-06-20' + (FLOOR(RANDOM() * 11)::int) * INTERVAL '1 day'
--     ELSE NULL
--   END;
-- 
-- -- 手动设置具体考试时间以确保合理分布(替代上面的随机分配)
-- UPDATE "public"."chenwk_course03" 
-- SET "cwk_final_exam_date03" = 
--   CASE 
--     -- 计算机科学与技术学院考试课程
--     WHEN "cwk_id03" = '1000   ' THEN DATE '2025-06-20'  -- 数据库原理
--     WHEN "cwk_id03" = '1001   ' THEN DATE '2025-06-21'  -- 计算机组成原理
--     WHEN "cwk_id03" = '1002   ' THEN DATE '2025-06-22'  -- 计算机网络原理
--     WHEN "cwk_id03" = '1004   ' THEN DATE '2025-06-23'  -- 操作系统原理
--     WHEN "cwk_id03" = '1005   ' THEN DATE '2025-06-24'  -- 算法设计与分析
--     WHEN "cwk_id03" = '1008   ' THEN DATE '2025-06-25'  -- 编译原理
--     WHEN "cwk_id03" = '1010   ' THEN DATE '2025-06-26'  -- 网络安全基础
--     WHEN "cwk_id03" = '1012   ' THEN DATE '2025-06-27'  -- 嵌入式系统
--     WHEN "cwk_id03" = '1013   ' THEN DATE '2025-06-28'  -- 分布式系统
--     WHEN "cwk_id03" = '1015   ' THEN DATE '2025-06-29'  -- 数字逻辑电路
--     
--     -- 信息学院考试课程
--     WHEN "cwk_id03" = '2000   ' THEN DATE '2025-06-20'  -- 信号与系统
--     WHEN "cwk_id03" = '2001   ' THEN DATE '2025-06-21'  -- 通信原理
--     WHEN "cwk_id03" = '2002   ' THEN DATE '2025-06-22'  -- 数字信号处理
--     WHEN "cwk_id03" = '2003   ' THEN DATE '2025-06-23'  -- 电磁场与电磁波
--     
--     -- 机械学院考试课程
--     WHEN "cwk_id03" = '3000   ' THEN DATE '2025-06-24'  -- 机械设计基础
--     WHEN "cwk_id03" = '3001   ' THEN DATE '2025-06-25'  -- 材料力学
--     
--     ELSE NULL  -- 考察课程不设置考试时间
--   END
-- WHERE "cwk_examination_method03" = '考试';
-- 
-- -- 验证考试课程和考试时间设置
-- SELECT "cwk_id03", "cwk_name03", "cwk_examination_method03", "cwk_final_exam_date03" 
-- FROM "public"."chenwk_course03" 
-- WHERE "cwk_examination_method03" = '考试' 
-- ORDER BY "cwk_final_exam_date03";
-- 
-- ----------------------------
-- Table structure for chenwk_course_schedule03
-- ----------------------------
...
-- ----------------------------
-- Records of chenwk_course_schedule03
-- ----------------------------
-- 计算机科学与技术学院(10000)的课程安排
...
-- ----------------------------
-- Table structure for chenwk_major03
-- ----------------------------
...
-- ----------------------------
-- Table structure for chenwk_score03
-- ----------------------------
...
-- ----------------------------
-- Table structure for chenwk_student03
-- ----------------------------
...
-- ----------------------------
INSERT INTO "public"."chenwk_teacher03" VALUES (20006, '李甜甜', '男', 1990, '讲师', 10000, '15421854678', 'zjut20006');
...
-- 触发器
-- ----------------------------
-- Function structure for decrease_student_count
-- ----------------------------
...
-- ----------------------------
-- Function structure for delete_score_record
-- ----------------------------
...
-- ----------------------------
-- Function structure for generate_score_record
-- ----------------------------
...
-- ----------------------------
-- Function structure for increment_student_count
-- ----------------------------
...
-- ----------------------------
-- Function structure for update_credit
-- ----------------------------
...
-- 存储过程
-- ----------------------------
-- Function structure for admin_change_password
-- ----------------------------
...
-- ----------------------------
-- Function structure for count_students_by_hometown
-- ----------------------------
...
-- ----------------------------
-- Function structure for insert_admin
-- ----------------------------
...
-- ----------------------------
-- Function structure for insert_class
-- ----------------------------
...
-- ----------------------------
-- Function structure for insert_college
-- ----------------------------
...
-- ----------------------------
-- Function structure for insert_course
-- ----------------------------
...
-- ----------------------------
-- Function structure for insert_course_schedule
-- ----------------------------
...
-- ----------------------------
-- Function structure for insert_major
-- ----------------------------
...
-- ----------------------------
-- Function structure for insert_student
-- ----------------------------
...
-- ----------------------------
-- Function structure for insert_teacher
-- ----------------------------
...
-- ----------------------------
-- Function structure for student_change_password
-- ----------------------------
...
-- ----------------------------
-- Function structure for teacher_change_password
-- ----------------------------
...
-- ----------------------------
-- Function structure for update_score
-- ----------------------------
...
-- ----------------------------
-- View structure for chenwk_teacher_course_schedule
-- ----------------------------
...
-- ----------------------------
-- View structure for chenwk_student_score_year
-- ----------------------------
...
-- ----------------------------
-- View structure for chenwk_teacher_course_score
-- ----------------------------
...
-- ----------------------------
-- View structure for chenwk_student_course
-- ----------------------------
DROP VIEW IF EXISTS "public"."chenwk_student_course";
CREATE VIEW "public"."chenwk_student_course" AS  SELECT chenwk_student03.cwk_id03 AS cwk_student_id03, 
    chenwk_course_schedule03.cwk_teacher_id03, 
    chenwk_teacher03.cwk_name03 AS cwk_teacher_name03, 
...
-- ----------------------------
-- Indexes structure for table chenwk_admin03
-- ----------------------------
...
-- ----------------------------
-- Uniques structure for table chenwk_college03
-- ----------------------------
...
CREATE INDEX "index_course_college_id" ON "public"."chenwk_course03" USING btree (
...
-- ----------------------------
-- Uniques structure for table chenwk_course03
-- ----------------------------
...
-- ----------------------------
-- Primary Key structure for table chenwk_course03
-- ----------------------------
ALTER TABLE "public"."chenwk_course03" ADD CONSTRAINT "chenwk_course_pkey" PRIMARY KEY ("cwk_id03");

-- ----------------------------
-- Indexes structure for table chenwk_course_schedule03
-- ----------------------------
...
-- ----------------------------
-- Primary Key structure for table chenwk_course_schedule03
-- ----------------------------
...
-- ----------------------------
-- Triggers structure for table chenwk_score03
-- ----------------------------
...
-- ----------------------------
-- Checks structure for table chenwk_score03
-- ----------------------------
...
-- ----------------------------
-- Triggers structure for table chenwk_student03
-- ----------------------------
...
-- ----------------------------
-- Foreign Keys structure for table chenwk_class03
-- ----------------------------
...
-- ----------------------------
-- Foreign Keys structure for table chenwk_course03
-- ----------------------------
...
-- ----------------------------
-- Foreign Keys structure for table chenwk_course_schedule03
-- ----------------------------
...
-- ----------------------------
-- Foreign Keys structure for table chenwk_major03
-- ----------------------------
...
-- ----------------------------
-- Foreign Keys structure for table chenwk_score03
-- ----------------------------
...
-- ----------------------------
-- Foreign Keys structure for table chenwk_student03
-- ----------------------------
...
-- ----------------------------
-- Foreign Keys structure for table chenwk_teacher03
-- ----------------------------
